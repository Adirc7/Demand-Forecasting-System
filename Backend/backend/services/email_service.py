...
def send_admin_reminder(days_left: int):
    sender_email = "assssdsad@gmail.com"
    receiver_email = "assssdsad@gmail.com"
    app_password = "dsadsfdfdsfds"

    msg = MIMEMultipart()
    msg['From'] = "'Dropex.AI Admin' <assssdsad@gmail.com>"
    msg['To'] = "Sales Management Team <assssdsad@gmail.com>"
